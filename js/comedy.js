function renderMovieSection(movies, container, numberToShow = 10, heading = "") {
  ...
  fetch("data/comedy.json")
    ...
    .then((data) => {
      const comedySectionsContainer = document.getElementById("comedy-sections-container");
      if (!comedySectionsContainer) return;
      ...
      categories.forEach((category, index) => {
        ...
        renderMovieSection(movies, comedySectionsContainer, 10, `Section ${index + 1}`);
      });
