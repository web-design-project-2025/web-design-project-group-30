function renderMovieSection(movies, container, numberToShow = 10, heading = "") {
  ...
  fetch("data/science-fiction.json")
    ...
    .then((data) => {
      const scienceFictionSectionsContainer = document.getElementById("science-fiction-sections-container");
      ...
      categories.forEach((category, index) => {
        ...
        renderMovieSection(movies, scienceFictionSectionsContainer, 10, `Section ${index + 1}`);
      });
