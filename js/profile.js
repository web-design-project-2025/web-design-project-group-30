document.addEventListener("DOMContentLoaded", () => {
  ...
  if (savedLanguage) {
    const languageDisplay = document.querySelector('.dropdown-container .dropdown-toggle p');
    if (languageDisplay) {
  ...
  if (savedLocation) {
    const locationDisplay = document.querySelector('.drop-up .dropdown-toggle p');
    if (locationDisplay) {
  ...
  languageOptions.forEach(option => {
    option.addEventListener('click', () => {
      ...
      document.querySelector('.dropdown-container .dropdown-toggle p').textContent = `${chosenLanguage} ▾`;
  ...
  locationOptions.forEach(option => {
    option.addEventListener('click', () => {
      ...
      document.querySelector('.drop-up .dropdown-toggle p').textContent = `${chosenLocation} ▴`;
